    ...
    <div class="easyui-panel" style="padding:5px;">
        ...
        <a href="#" class="easyui-menubutton" data-options="menu:'#mm1',iconCls:'icon-edit'">Tool</a>
       ...
       <!-- <a href="#" class="easyui-menubutton" data-options="menu:'#mm3'">ออกจากระบบ</a> -->
        <a href="#" class="easyui-linkbutton" iconCls="icon-cancel">Sign Out</a>
    </div>
